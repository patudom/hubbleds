.. These are examples of badges you might want to add to your README:
   please update the URLs accordingly
    ...
    .. image:: https://api.cirrus-ci.com/github/<USER>/hubbleds.svg?branch=main
        :alt: Built Status
        :target: https://cirrus-ci.com/github/<USER>/hubbleds
    .. image:: https://readthedocs.org/projects/hubbleds/badge/?version=latest
        :alt: ReadTheDocs
        :target: https://hubbleds.readthedocs.io/en/stable/
    .. image:: https://img.shields.io/coveralls/github/<USER>/hubbleds/main.svg
        :alt: Coveralls
        :target: https://coveralls.io/r/<USER>/hubbleds
    .. image:: https://img.shields.io/pypi/v/hubbleds.svg
        :alt: PyPI-Server
        :target: https://pypi.org/project/hubbleds/
    .. image:: https://img.shields.io/conda/vn/conda-forge/hubbleds.svg
        :alt: Conda-Forge
        :target: https://anaconda.org/conda-forge/hubbleds
    .. image:: https://pepy.tech/badge/hubbleds/month
        :alt: Monthly Downloads
        :target: https://pepy.tech/project/hubbleds
    .. image:: https://img.shields.io/twitter/url/http/shields.io.svg?style=social&label=Twitter
        :alt: Twitter
        :target: https://twitter.com/hubbleds
